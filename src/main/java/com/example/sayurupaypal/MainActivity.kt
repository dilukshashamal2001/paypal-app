package com.example.sayurupaypal
...
class MainActivity: Activity() {
    ...
    fun onFuturePaymentPressed(pressed: View) {
        val intent = Intent(this@MainActivity, PayPalFuturePaymentActivity::class.java)
    ...
    fun onProfileSharingPressed(pressed: View) {
        val intent = Intent(this@MainActivity, PayPalProfileSharingActivity::class.java)
